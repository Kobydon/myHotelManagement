...
async getCategoryList() {
  ...
  async findDepartment(data){
    ...
    const d = {
      ...
      waiter:this.createForm.value.barrest,
  ...
  async findWaiter(){
    ...
    const d = {
      ...
      try{
        this.loading.start();
       var res = await this.guestService.searchattendantDatesTwo(d);
       if (res)this.incomeReport =res;
  ...
  async searchDates(){
    ...
    async searchIncomeDates(data,datatwo){
      let sum :number= 0;
      const d = {
        date: data,
        datetwo:datatwo
        ...
        try{
          this.loading.start();
         var res = await this.guestService.searchCanceledDate(d);
         if (res)this.incomeReport =res;
    ...
    async searchExpenseDates(data,datatwo){
      let sum :number= 0;
      const d = {
        date: data,
        datetwo:datatwo
        ...
        try{
          this.loading.start();
          var res = await this.guestService.searchExpenseDateTwo(d);
